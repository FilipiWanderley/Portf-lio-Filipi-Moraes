...
const ScrambledTitle: React.FC = () => {
  ...
  return (
    <h1
      ref={elementRef}
      className="text-white text-4xl md:text-6xl font-bold tracking-wider justify-center text-center w-full px-4"
...
const RainingLetters: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      <style>{`
        .dud {
          color: #60a5fa; /* COR AZUL CLARO (GLITCH) */
          opacity: 0.7;
        }
      `}</style>
    </div>
